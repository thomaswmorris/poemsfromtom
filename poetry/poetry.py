...
class Poetizer:
    ...
    def load_poem(self,
        ...
        self.poem_html = f"""
        <html>
        <h2 style="font-family:Garamond; color:{html_color}; font-size: 26px; margin-bottom:0; margin : 0; padding-top:0;">{self.titleize(self.title)}
            <style="font-family:Garamond; color:{html_color}; font-size: 18px; margin-bottom:0; margin : 0; padding-top:0;"><i>by 
            <a href="{self.link}">{self.name}</a> ({self.birth}&#8212;{self.death})</i> </h2>
